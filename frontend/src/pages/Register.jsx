          ...
          <div className="mt-12">
            <form>
              ...
              <div className="mt-8">
                ...
                <input className="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" placeholder="John Doe" />
              </div>
              <div className="mt-8">
                <div className="flex justify-between items-center">
                  <div className="text-sm font-bold text-gray-700 tracking-wide">
            ...
            <div className="mt-12 text-sm font-display font-semibold text-gray-700 text-center">
              Do you already have an account? <a className="cursor-pointer text-indigo-600 hover:text-indigo-800">Log in</a>
            </div>
          </div>
        </div>
      </div>
